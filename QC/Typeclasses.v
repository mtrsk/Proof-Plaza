...
Compute string_of_nat_aux 0 1301 "".
Compute string_of_nat_aux 1 1301 "".
Compute string_of_nat_aux 2 1301 "".
...
Definition show_of_NatBool (x : nat * bool) : string :=
  "(" ++ show (fst x) ++ ", " ++ show (snd x) ++ ")".

Instance showNatBool : Show (nat * bool) :=
  {
    show := show_of_NatBool
  }.
