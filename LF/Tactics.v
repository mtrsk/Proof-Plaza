...
Proof.
  intros X x y z l j.
  intros H1 H2.
  injection H1. intros H3 H4.
  injection H2. intros H5 H6.
  rewrite -> H6.
  reflexivity.
Qed.
(** [] *)
...
Proof.
  intros X Y l1. induction l1 as [| x' l' IHl'].
  - intros l2 H. simpl. inversion H.
    destruct l2.
    + reflexivity.
    + discriminate H1.
Abort.
